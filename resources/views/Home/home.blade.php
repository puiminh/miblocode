                                    ...
                                    <div class="main-left-sidebar no-margin">
                                        ...
                                        <div class="suggestions full-width">
                                            ...
                                            <div class="suggestions-list">
                                                <?php
                                                    $all_of_user = User::get()->sortByDesc('created_at')->take(5);
                                                ?>

                                                @foreach($all_of_user as $user_rec)
                                                <div class="suggestion-usd">
                                                    
                                                    <div class="sgt-text">
                                                        <h4><a class="title-link" href="{{url('userpost/'.$user_rec->id)}}">{{$user_rec->name}}</a></h4>
                                                        <span>Tạo tài khoản vào {{Carbon\Carbon::parse($user_rec->created_at)->diffForHumans()}}</span>
                                                    </div>
                                                ...
                                                <div class="view-more mb-3">
                                                    <a href="{{route('userlist')}}" title="">View More</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="user-picy col-1">
                                            ...
                                            <div class="col-9 text-center">
                                                ...
                                                <span class="h4 text-muted status-text pl-3">
                                                    Có {{$post_count_all}} kết quả tìm kiếm cho {{session('search')}}
                                                </span>
                                                @else
                                                <span class="h4 text-muted status-text pl-3">
                                            ...
                                            <div class="post-st col-1 d-flex">
                                                

                                                <a class="btn btn-danger pb-1" href="{{route('newpost')}}" style="margin-top: -5px;">
                                                ...
                                                <div class="post-bar">
                                                        <div class="post_topbar">
                                                            ...
                                                            @endif
                                                                ...
                                                                <div href="{{url('userpost/'.$post->user->id)}}" class="usy-name pt-1 mt-1">
                                                                    <h3><a class="title-link" href="{{url('userpost/'.$post->user->id)}}">{{$post->user->name}}</a></h3>
