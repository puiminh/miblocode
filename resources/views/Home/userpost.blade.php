                                    ...
                                    <div class="row">
                                        ...
                                        <div class="user-picy col-1">
                                            ...
                                            <div class="col-9 text-center">
                                                ...
                                                Bài viết mà <span class="font-weight-bold text-warning">{{$loginUser->name}}</span> đã đăng
                                                </span>
                                            </div>
                                                        ...
                                                        <div class="post_topbar">
                                                            ...
                                                            <div class="ed-opts">
                                                                ...
                                                                <ul class="ed-options">
                                                                    ...
                                                                    <?php
                                                                    $checkbookmark =0;
                                                                        if (Bookmark::where('user_id',$loginUserN->id)->where('post_id',$post->id)->first()) 
                                                                        $checkbookmark = 1;
                                                                        else
                                                                        $checkbookmark = 0;
                                                                    ?>
                                                                    ...
                                                                    @if($checkbookmark==1)
                                                                    <li>
                                                                        <form class="{{'form-bookmark'}}" action="{{url('bookmark/'.$loginUserN->id.'/'.$post->id)}}" method="GET" target="if-content">
                                                ...
                                                @endforeach    
                                                        ...
                                                        <div class="job-status-bar">
                                                            <ul class="like-com">
                                                                ...
                                                                <form class="react-form" action="{{ url('like/'.$loginUserN->id.'/'.$post->id) }}" method="GET" target="if-content">
                                                                ...
                                                                @php($vote = 0)
                                                                @php(
                                                                    ($loginUserN->vote($post->id))&&$vote = $loginUserN->vote($post->id)->vote)
                                                                @if($vote == 1) 
                                                                ...
                                                                <form class="react-form" action="{{ url('dislike/'.$loginUserN->id.'/'.$post->id) }}" method="GET" target="if-content">
                                                    ...
                                                    <div class="comment-section collapse" id="{{'collapseComment'.$i}}">
                                                            ...
                                                            <div class="post-comment">
                                                                ...
                                                                <div class="comment_box">
                                                                    <form class="comment-form" action="{{ url('comment/'.$loginUserN->id.'/'.$post->id) }}" method="GET" target="if-content">
