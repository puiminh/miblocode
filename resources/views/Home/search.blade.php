                                ...
                                <div class="col-lg-3 col-md-4 pd-left-none no-pd">
                                    <div class="main-left-sidebar no-margin">
                                        ...
                                        <div class="suggestions full-width">
                                            <div class="sd-title">
                                                <h3>Suggestions</h3>
                                                <box-icon name='dots-vertical-rounded' color='#4e3f3f' ></box-icon>
                                            </div>
                                            <div class="suggestions-list">
                                                <div class="suggestion-usd">
                                                    ...
                                                    <span>
                                                    <box-icon name='plus' color='#b0abab' ></box-icon>
                                                    </span>
                                                </div>
                                                <div class="suggestion-usd">
                                                    <img src="" 
                                        ...
                                        <div class="user-picy col-1">
                                            ...
                                            <div class="col-9 text-center">
                                                ...
                                                <span class="h4 text-muted status-text pl-3">
                                                    Có <span class="text-success">{{$post_count_all}}</span> kết quả tìm kiếm cho "<span class="font-italic">{{$search}}</span>"
                                                </span>
                                                    ...
                                                    <div class="comment-section collapse" id="{{'collapseComment'.$i}}">
                                                            ...
                                                            <div class="post-comment">
                                                                ...
                                                                <div class="comment_box">
                                                                    ...
                                                                    <h6 class="text-center text-muted cmt-loading hide-div">Loading...</h6>
